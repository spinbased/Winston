/**
 * Working AI Legal Assistant - FIXED for Railway
 * The issue: ExpressReceiver endpoints config doesn't work as expected
 * Solution: Don't specify endpoints path, use default, and update Slack URL
 */

import { App, ExpressReceiver } from '@slack/bolt';
import Anthropic from '@anthropic-ai/sdk';

// Create receiver WITHOUT custom endpoints path
// Bolt will automatically handle /slack/events and /slack/commands
...
(async () => {
  ...
  console.log('');
  console.log('🔍 Bolt SDK will handle /slack/* routes automatically');
  console.log('   Make sure Slack Event Subscriptions URL is:');
